...
def menu():
    ...
    psb('\x1b[1;92m[2]  AIRTEL')
    psb('\x1b[1;92m[3]  BANGLALINK(OLD)')
    psb('\x1b[1;92m[4]  BANGLALINK(NEW)')
    psb('\x1b[1;92m[5]  GGRAMEENPHONE(New)')
    psb('\x1b[1;92m[6]  ROBI')
    psb('\x1b[1;92m[7]  CONTACT ME')
    psb('\x1b[1;92m[0]  EXIT')
    psb('\x1b[1;94m--------------------------------------------------')
    action()
